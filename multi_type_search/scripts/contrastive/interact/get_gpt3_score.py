...
def gpt3_score(model, input_strings, trajectory_creation_method: str = 'add'):
...
if __name__ == "__main__":
    ...
    while True:
        ...
        score = gpt3_score(model, input_strings, args.trajectory_creation_method)
