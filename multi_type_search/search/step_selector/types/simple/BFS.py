...
class BFSSelector(StepSelector):
    """
    Breadth First Search Selector
    A simple step selector that will always favor shallow steps (older steps).
    """
    search_obj_type: str = 'BFS_step_selector'
    ...
    def add_steps(self, steps: List[Step], graph: Graph = None) -> None:
        self.step_list = [*self.step_list, *steps]
