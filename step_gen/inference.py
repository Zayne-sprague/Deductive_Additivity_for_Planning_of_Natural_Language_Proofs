"""
TODO - this is very close to generate.py, but the generate.py file isn't working (maybe using old version of HF stuff)
"""
...
TRAINED_MODELS_FOLDER = Path(__file__).parent.parent.resolve() / 'trained_models'
